...
a1111_image = (
    ...
    .run_commands(
        ...
        "aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Qwen/Qwen2-VL-1.5B-Instruct/resolve/main/model.safetensors -d /app/webui/models/qwen -o Qwen2-VL-1.5B-Instruct.safetensors",
